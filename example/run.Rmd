...
For those who are not cured, we generate the survival time from an accelerated failure time (AFT) model:
...
The arguments are in `dat_with_cure()` are as follow: 
  ...
  * `para1`: Represents the regression coefficients in the latency component of the model.
  * `para2`: Represents the regression coefficients in the incidence component of the model.
